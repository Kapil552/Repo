package com.springhibernateannotdemo.main;
...
import com.springhibernateannotdemo.config.SpringConfig;
import com.springhibernateannotdemo.dao.ProductDao;
import com.springhibernateannotdemo.daoimpl.ProductDaoImpl;
...
public class AppMain {
	...
	public static void main(String[] args) {
		...
		ProductDao daoImpl = context.getBean(
